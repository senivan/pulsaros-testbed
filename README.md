...
Provisioning, diagnostics, and VM teardown are parallelized by default.
`ANSIBLE_FORKS` controls Ansible provisioning fan-out, `PVE_COLLECT_JOBS`
controls how many hosts collect logs at once, and `PVE_DESTROY_JOBS` controls
how many VMs are stopped and destroyed at once.
